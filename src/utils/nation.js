export const geoCoordMap = {
    // IDS监控数据
    "ChinaBeijing":[116.3883,39.9289],
    "United StatesCambridge":[-71.0843,42.3626],
    "Chinanull":[105,35],
    "ChinaGuangzhou":[113.25,23.1167],
    "United StatesScottsdale":[-111.9237,33.4912],
    "JapanTokyo":[139.7514,35.685],
    "United StatesSan Francisco":[-122.3933,37.7697],
    "ChinaHebei":[115.275,39.8897],
    "Germanynull":[9,51],
    "United StatesManchester":[-71.4652,42.9885],
    "United Statesnull":[-97,38],
    "Switzerlandnull":[8,47],
    "United StatesMountain View":[-122.0574,37.419200000000004],
    "Irannull":[51.4231,35.6961],
    "United StatesPasadena":[-118.1662,34.1484],
    "Francenull":[2.35,48.86],
    "United StatesFalls Church":[-77.1922,38.864],
    "ChinaChangsha":[113.1136,28.1792],
    "ChinaShanghai":[121.3997,31.0456],
    "ChinaTaizhou":[119.9081,32.4907],
    "ChinaHefei":[117.2808,31.8639],
    "United StatesAtlanta":[-84.388,33.749],
    "ChinaNanjing":[118.7778,32.0617],
    "United StatesSanta Monica":[-118.4682,34.0119],
    "CanadaFredericton":[-66.6763,45.8119],
